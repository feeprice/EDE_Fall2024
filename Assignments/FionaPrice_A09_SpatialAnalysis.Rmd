...
as it uses angular coordinate units. This CRS is associated with NAD83 data. 
> 
...
countymap <- mapView(NE_counties, col.regions = "red")
gagemap <- mapView(flow_data, cex = "gage_ht")
countymap + gagemap
```
...
#21 Plot the data
ggplot() +
  geom_sf(data = transformed_counties, fill = "red") +
...
lancaster_buffer_15km <- st_buffer(lancaster, 15000)
...
#25 Plot
mapview(gages_buffered, col.regions = "grey") +
  mapview(lancaster_gages, col.regions = "red") +
  mapview(lancaster, col.regions = "blue") +
  mapview(transformed_counties, col.regions = "light blue")
```
