...
map1 <- mapView(NE_counties, col.regions = "gray")
map2 <- mapView(flow_data, cex = "gage_ht")
map1 + map2
```
...
#21 Plot the data
ggplot() +
  geom_sf(data = transformed_counties, color = "red") +
...
mapview(lancaster, color = "red")


#23 Spatially select gages within the selected county
lancaster_gages <- transformed_gages %>%  
...
gages_buffered <- transformed_gages %>%  
  st_filter(lancaster_buffer_15km, .predicate = st_intersects)


#25 Plot
mapview(gages_buffered)
```
