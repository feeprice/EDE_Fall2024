...
#11. Create a function using ifelse(). The "test" is my.function > 50, the 
#"yes" is "Pass" and the "no" is "Fail.
...
vector. In the case of test_scores there are three values, so we need to use 
...
of `if`...`else. I did find that `if`...`else works if I use any() before 
my.function because then it tells R to look at each test score value.
