...
#Create a map with both
map1 <- mapView(huc8_sf, col.regions = "gray")
map2 <- mapView(huc8_sf_UpperNeuse, col.regions = "yellow", color = 'blue')
map1 + map2

#Another way
ggplot() +
  geom_sf(data = huc8_sf, fill = 'grey')+
  geom_sf(data = huc8_sf_UpperNeuse, fill = 'yellow', color = 'blue')
...
#Note that it would make more sense to take the average of the average, but we did
#this to match the answer sheet

#Join to HUC_8 features
huc_wind <- huc8_sf %>% 
  left_join(wind_energy)
