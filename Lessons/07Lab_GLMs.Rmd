...
#p-value <2e-16. R-squared value = 0.1314.
...
AIC <- lm(data = EPAair, PM2.5 ~ meanLat + meanLong + 
              month + year + Ozone)
step(AIC)
...
OzoneBest.reg <- lm(data = EPAair, PM2.5 ~ Ozone + meanLat + meanLong + month)
