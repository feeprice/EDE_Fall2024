...
Assumptions: 
1. All pops normally distributed
2. Pop variances are equal
...
#results: reject null in all except two: NIWO_057 and NIWO_046. we reject null
#because p-value is significant. 
...
#Data clearly does not follow normal distribution
...
#specify df, continuous variable, and categorical variable
...
#compares all possible group pairings
TukeyHSD(Litter.Totals.anova)

# Extract groupings for pairwise relationships
Litter.Totals.groups <- HSD.test(Litter.Totals.anova, "plotID", group = TRUE)
#tries to find groupings that have similar means
#group = true means find groups that have similar means
...
#use times instead of plus to see interaction between them
