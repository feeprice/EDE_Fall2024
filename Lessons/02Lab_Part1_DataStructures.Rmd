...
#Combine vector 1 and vector 4
c(vector1, vector4)

#Multiply the values in vector 1 and vector 4
vector1 * vector4

#Multiply each value in vector 1 by 10
vector1 * 10

#Convert lower-case characters in vector 2 to upper-case characters
toupper(vector2) 

#Reverse the items in a logical vector
!vector3
...
matrix1[4, 1] #accesses the value in row 4 column 1
class(matrix1)

matrix1[4,  ] #accesses all of the elements in the 4th row

matrix1[ , 3] #accesses all of the elements in the 3rd column

matrix1[c(12, 14)] #gives you the element stored in the 12th and 14th position of the matrix

matrix1[c(12:14)] #

matrix1[2:4, 1:3] #get a sub-matrix from an existing matrix
...
#Return only the age object of list1
list1$age

#Return only the names object of list1
names(list1)

#Returns the first 2 objects of list1
list1[1:2]

#Sets the value of the name object to Janelle
list1$name = "Janelle"

#Sets the value of the 4th object (age) to 44
list1[[4]] = 44
```
